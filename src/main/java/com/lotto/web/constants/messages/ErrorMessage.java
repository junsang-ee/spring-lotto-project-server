...
public enum ErrorMessage {
    ...
    LOTTO_INVALID_ROUND("1010"),
    LOTTO_DUPLICATED_ROUND("1011"),
    LOTTO_NOT_DRAW_ROUND("1012"),
    LOTTO_EXCEED_NUMBER("1013"),

    EXTRACTION_NOT_FOUND("2000"),
    EXTRACTION_NOT_WAITING("2001"),
